    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(JoinActivity.this, AddActivity.class));
            }
        });
    ...
    public void onItemClick(AdapterView<?> parent, View view, int i, long x) {
        ...
        builder.setItems(options, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch (which){
                    case 0:
                        final AlertDialog.Builder viewData = new AlertDialog.Builder(JoinActivity.this);
                ...
                switch (which){
                    case 1:
                        Intent iddata = new Intent(JoinActivity.this, EditActivity.class);
                    ...
                    case 2:
                        ...
                        builder1.setPositiveButton("Hapus", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Toast.makeText(JoinActivity.this, "Data Terhapus", Toast.LENGTH_SHORT).show();
                                setListView();
                            }
                        });
